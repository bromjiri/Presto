...
def process_day(day, month, subject):
    ...
    input_file = settings.DOWNLOADS_TWITTER + "/" + subject + "/twitter-" + subject + "-2016-" + month + "-" + day + "-fix.csv"
...
us_holidays = "../data/sentiment/us_holidays.txt"
...
for subject in subjects:
    ...
    output_file = "../data/sentiment/twitter/twitter-sent-" + subject + "-2016-" + month_str + ".csv"
