...
class Features:
    ...
    def __init__(self, corpora, total, inf_count=5000, bigram_count=50, pos=None, stop=False, stem="none", bigram=False, lower=True):
    ...
    def create_bestbigrams(self):
        ...
        best = sorted(word_scores.items(), key=lambda tup: tup[1], reverse=True)[:1000]
        print(best)
        bestwords = set([w for w, s in best])
        print(bestwords)
        print(len(bestwords))
